...
import com.zh.api.enums.SysConstant;
import com.zh.api.utils.RandomNumbers;
import com.zh.api.utils.SnowFlake;
...
public class KillServiceImpl implements KillService {
    ...
    public Boolean killItemV3(Integer killId, Integer userId) throws Exception {
        ...
        if (itemKillSuccessMapper.countByKillUserId(killId,userId) <= 0){
            ...
            final String value=RandomNumbers.generateOrderCode();
    ...
    public void commonRecordKillSuccessInfo(ItemKill kill,Integer userId) throws Exception{
        ...
        entity.setItem_id(kill.getItem_id());
        entity.setKill_id(kill.getId());
        entity.setUser_id(userId.toString());
        entity.setStatus(SysConstant.OrderStatus.SuccessNotPayed.getCode().byteValue());
        entity.setCreate_time(DateTime.now().toDate());
        //TODO:双重检验锁写法
