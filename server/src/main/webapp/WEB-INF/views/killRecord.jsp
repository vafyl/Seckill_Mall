...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-body">
            <h2>当前用户名：</h2><h2 class="text-danger">${info.user_name}</h2>
        </div>
        <div class="panel-body">
        ...
        <div class="panel-body">
            <h2>成功抢购的时间：</h2><h2 class="text-danger"><fmt:formatDate value="${info.create_time}" pattern='yyyy-MM-dd HH:mm:ss'/></h2>
        </div>
        <div class="panel-body">
            <h2>当前支付的状态：</h2>
